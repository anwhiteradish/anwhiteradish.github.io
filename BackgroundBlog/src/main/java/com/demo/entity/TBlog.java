...
public class TBlog implements java.io.Serializable {
	...
	public String toString() {
		return "TBlog [id=" + id + ", title=" + title + ", summary=" + summary + ", releaseDate=" + releaseDate
				+ ", readCount=" + readCount + ", commentCount=" + commentCount + ", content=" + content + ", keyWord="
				+ keyWord + ", blogType=" + blogType + ", isShow=" + isShow + ", isReply=" + isReply + ", isCommend="
				+ isCommend + ", typeId=" + typeId + "]";
	}
