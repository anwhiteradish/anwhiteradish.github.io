            ...
            <div class="blog-main">
                <div class="blog-main-left">
                    <div class="shadow" style="text-align:center;font-size:16px;padding:40px 15px;background:#fff;margin-bottom:15px;">
                       搜索到${searchCount}篇与【<span style="color: #FF5722;">${keywords}</span>】有关的文章，随便看看吧！
                    </div>
                    ...
                    <div class="article shadow">
                        ...
                        <div class="article-footer">
                            <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;<fmt:formatDate value="${item.releaseDate }" pattern="yyyy-MM-dd"/> </span>
                    ...
                    <a <c:if test="${currentPage>1 }"> href="${pageContext.request.contextPath }/article?currentPage=${currentPage-1}" </c:if>>pre</a>
                    <a <c:if test="${currentPage<totalPage }"> href="${pageContext.request.contextPath }/article?currentPage=${currentPage+1}" </c:if>>next</a>
                    
                </div>
                <div class="blog-main-right">
                    <div class="blog-search">
                        <form class="layui-form" name="formName1" action="" method="post">
                            <div class="layui-form-item">
                                <div class="search-keywords  shadow">
                                    <input type="text" name="keywords" id="keywords1" lay-verify="required" placeholder="输入关键词搜索" value="${keywords}" autocomplete="off" class="layui-input">
                                </div>
                                <div class="search-submit  shadow">
                                    <a class="search-btn" id="btn123" lay-submit="formSearch" lay-filter="formSearch"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
$("#btn123").click(function(){
	alert("123")
	document.formName1.action="${pageContext.request.contextPath}/search";
	document.formName1.submit();
	/* $.post("${pageContext.request.contextPath}/search",{"keywords":$("#keywords1").val()},function(data){
